...
log = open(r"C:\Users\siwei\OneDrive\Paper\Final Code\Experiment\V&A\DQSND\hep_log_dir_Cit-HepPh_0.001.txt","w")
#Data = r"C:\Users\siwei\OneDrive\Paper\Final Code\DATA\Cit-HepTh.txt"
Data = r"C:\Users\siwei\OneDrive\Paper\Final Code\DATA\Cit-HepPh.txt"
...
def run_it():
    ...
    #print(EN.IC(G.graph,{2757, 25352, 43244, 29452, 53296, 9968, 32083, 54101, 52793, 11612}))
    #input()
    episode = 0
    while(episode < Round):
        print(episode)
        ...
        while(True):
            ...
            if len(test.seed) == budget:
                ...
                print("Error !! Loosen the restriction!")
                sigmoid = sigmoid * 1.1
                step_c = 0
            ...
            if TRAIN == 1:
                ...
                action = RL.choose_action_no_ran([test.netInput[0]*sigmoid] + test.netInput[1:3])
            print("Occupied budget: ",len(test.seed))

            if action == 0 and test.list[step_c][0] not in test.seed: #accepted\
