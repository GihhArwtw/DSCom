...
def strength_list(g,budget):
    ...
    G = nx.Graph()
    # -----changed file path-------
    with open(r'/content/drive/MyDrive/data/NetHEPT.txt') as f:
        f.readline()
        for line in f:
    ...
    with open(r'/content/drive/MyDrive/data/NetHEPT.txt') as f:
        ...
        for line in f:
            ...
            try:
                ...
                G.add_edge(u,v, weight=1)
    # -----changed file path-------
    log = open(r"/content/drive/MyDrive/V&A/ExpRes/0.1_phy_10_70_Q&A.txt/0.1_hep_10_70_Q&A.txt","w")
