...
def read_from_txt(filename, p = 0.0000001):
    """
...
def strength_list(g,budget):
    ...
    G = nx.Graph()
    # ----------modified----------
    with open(r'/content/drive/MyDrive/data/transCit-HepPh.txt') as f:
        f.readline()
        for line in f:
    ...
    A = t[0:budget*20]
    print("finished strength list")
    return A;

#test = Env(r"C:\Users\siwei\Desktop\Paper\Final Code\DATA\hep.txt",60)
#print(test.list)
#print(test.graph)
